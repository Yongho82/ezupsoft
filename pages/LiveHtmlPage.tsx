    ...
    <div className="w-full pb-20 bg-white selection:bg-purple-100 selection:text-purple-900 overflow-x-hidden">
      ...
      <section className="relative pt-12 pb-16 md:pt-20 md:pb-28 overflow-hidden bg-slate-50 border-b border-slate-100">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
           ...
           <h1 className="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-6 leading-snug animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
             {t('html.title')}
           </h1>
           
           <p className="text-base md:text-lg text-slate-500 max-w-3xl mb-8 leading-relaxed mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
             {t('html.desc')}
           </p>
