    ...
    <div className="w-full pb-0 bg-[#050505]">
      ...
      >
         ...
         <div className="max-w-[1400px] mx-auto px-4 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto md:grid-rows-[200px_200px_100px_80px] gap-4">
                        ...
                        <div className="flex items-center justify-between gap-4">
                           <div className="flex items-center gap-4">
                               <div className={`p-3 rounded-2xl bg-gradient-to-br ${currentSlide.gradient} text-white shadow-lg shadow-black/50`}>
                                   <Icon icon={activeBentoIndex === 0 ? "solar:code-bold" : activeBentoIndex === 1 ? "solar:file-text-bold" : "solar:crop-minimalistic-bold"} width="24" />
                               </div>
                               <div>
