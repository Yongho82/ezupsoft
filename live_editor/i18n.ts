...
export const translations: { [key: string]: Translation } = {
    ...
    ja: {
        ...
        header: {
            ...
            importPptx: "pptx",
            importImg: "img",
            previewSize: "プレビューサイズ調整",
            previewScale: "プレビュー拡大/縮小",
            editControls: "編集",
            showAllText: "すべてのテキストを表示",
            hideAllText: "すべてのテキストを非表示",
            splitView: "HTML + プレビュー",
            editorView: "HTML",
            previewView: "プレビュー",
            newTabView: "新しいタブでプレビュー",
            download: "ダウンロード",
            downloadHtml: "html",
            downloadPdf: "pdf",
            downloadPptx: "pptx",
            downloadImage: "img",
            downloadPptxLoading: "PPTX ダウンロード (読み込み中...)",
            downloadPptxError: "PPTX ダウンロード (エラー)",
            downloadPdfLoading: "PDF ダウンロード (読み込み中...)",
            downloadPdfError: "PDF ダウンロード (エラー)",
        },
    },
    zh: {
        ...enTranslations,
        header: {
            ...
            downloadPptx: "pptx",
            downloadImage: "img",
            downloadPptxLoading: "下载 PPTX (加载中...)",
            downloadPptxError: "下载 PPTX (错误)",
            downloadPdfLoading: "下载 PDF (加载中...)",
            downloadPdfError: "下载 PDF (错误)",
        },
    },
    es: {
        ...enTranslations,
        header: {
            title: "Estudio HTML en vivo",
            languageChange: "Idioma",
            languageToggleTooltip: "Cambiar idioma",
            manual: "Manual",
            layers: "Capas",
            ...
            importPptx: "pptx",
            importImg: "img",
            previewSize: "Ajustar tamaño de vista previa",
            previewScale: "Zoom de vista previa",
            editControls: "Editar",
            showAllText: "Mostrar todo el texto",
            hideAllText: "Ocultar todo el texto",
            splitView: "HTML + Vista previa",
            editorView: "HTML",
            previewView: "Vista previa",
            newTabView: "Vista previa en nueva pestaña",
            download: "Descargar",
            downloadHtml: "html",
            downloadPdf: "pdf",
            downloadPptx: "pptx",
            downloadImage: "img",
            downloadPptxLoading: "Descargar PPTX (Cargando...)",
            downloadPptxError: "Descargar PPTX (Error)",
            downloadPdfLoading: "Descargar PDF (Cargando...)",
            downloadPdfError: "Descargar PDF (Error)",
        },
    },
    fr: {
        ...enTranslations,
        header: {
            title: "Studio HTML en direct",
            ...
            importPptx: "pptx",
            importImg: "img",
            previewSize: "Ajuster la taille de l'aperçu",
            previewScale: "Zoom de l'aperçu",
            editControls: "Modifier",
            showAllText: "Afficher tout le texte",
            hideAllText: "Masquer tout le texte",
            splitView: "HTML + Aperçu",
            editorView: "HTML",
            previewView: "Aperçu",
            newTabView: "Aperçu dans un nouvel onglet",
            download: "Télécharger",
            downloadHtml: "html",
            downloadPdf: "pdf",
            downloadPptx: "pptx",
            downloadImage: "img",
            downloadPptxLoading: "Télécharger PPTX (Chargement...)",
            downloadPptxError: "Télécharger PPTX (Erreur)",
            downloadPdfLoading: "Télécharger PDF (Chargement...)",
            downloadPdfError: "Télécharger PDF (Erreur)",
        },
    },
    de: {
        ...enTranslations,
        header: {
            title: "Live-HTML-Studio",
            languageChange: "Sprache",
            languageToggleTooltip: "Sprache wechseln",
            manual: "Handbuch",
            layers: "Ebenen",
            ...
            previewScale: "Vorschau-Zoom",
            editControls: "Bearbeiten",
            showAllText: "Alle Texte anzeigen",
            hideAllText: "Alle Texte ausblenden",
            splitView: "HTML + Vorschau",
            editorView: "HTML",
            previewView: "Vorschau",
            newTabView: "Vorschau in neuem Tab",
            download: "Herunterladen",
            downloadHtml: "html",
            downloadPdf: "pdf",
            downloadPptx: "pptx",
            downloadImage: "img",
            downloadPptxLoading: "PPTX herunterladen (Lädt...)",
            downloadPptxError: "PPTX herunterladen (Fehler)",
            downloadPdfLoading: "PDF herunterladen (Lädt...)",
            downloadPdfError: "PDF herunterladen (Fehler)",
        },
    },
};